    ...
    <div class="p-3 d-none d-md-block">
        ...
        <ol class="list-group list-group-flush mb-0">
            <?php foreach(get_popular_users() as $user) : ?>
                <li class="list-group-item"><a href="<?php echo BASE_URI; ?>?user=<?php echo urlencode($user->full_name); ?>"><?php echo $user->full_name; ?><span class="ml-3 badge badge-info"><?php echo $user->topics_count; ?></span></a></li>
            <?php endforeach; ?>
        </ol>
    </div>
